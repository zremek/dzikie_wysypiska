...
### Powierzchnia na mapach

```{r powierzchnia-duze-tab}
str(d)
d %>% select(ec5_uuid, title, `10_Jak_oceniasz_powi`) %>% 
  filter(`10_Jak_oceniasz_powi` == "większe niż 501 m. kw - plac Dąbrowskiego, boisko piłkarskie")
...
sjPlot::tab_xtab(var.row = cechy_tak$Jak_oceniasz_powi,
                 var.col = cechy_tak$Jaki_jest_charakt)
